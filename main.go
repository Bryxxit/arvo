...
func main() {
	...
	if c.CodeDir == "" {
		c.CodeDir = "/etc/puppetlabs/code/environments/production"
	}
	...
	docs.SwaggerInfo.Title = "Arvo is puppet cleanup helper and hiera manager tool"
